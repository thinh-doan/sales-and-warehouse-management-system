...
# ==============================================================================
# 1. DIALOG: THÊM / CẬP NHẬT ĐỐI TÁC
# ==============================================================================
...
# ==============================================================================
# 3. CONTROLLER: ĐIỀU KHIỂN TRANG ĐỐI TÁC & HỆ THỐNG
# ==============================================================================
class PartnerPageController:
    ...
    def _connect_signals(self):
        ...
        self.window.btnXoaDT.clicked.connect(self.delete_partner_with_confirm)
        
        # Chức năng Đăng xuất (Kiểm tra xem nút bấm có tồn tại trên giao diện window hay không)
        if hasattr(self.window, 'btnDangXuat'):
            self.window.btnDangXuat.clicked.connect(self.logout)
    ...
    def logout(self):
        ...
        if answer == QMessageBox.StandardButton.Yes:
            try:
                # Đóng cửa sổ chính (Main Window) đang chứa controller này
                self.window.close()
                
                # Lưu ý bổ sung: Nếu bạn muốn hiển thị lại màn hình đăng nhập, 
                # hãy import class Đăng nhập của bạn tại đây và hiển thị nó lên.
                # Ví dụ:
                ...
                QMessageBox.critical(self.window, "Lỗi", f"Không thể thực hiện đăng xuất.\n{exc}")